...
// ======== BEGIN OF SOLUTION - TASK 3_3-2 ======== //
    ...
    // spotlight, chceme z mista pozorovatele,  proto - vertexPosition
  vec3 L = normalize(light.position - vertexPosition); // smer ke svetlu
  ...
  float spotCoef = max(0.0, dot(light.spotDirection, -L));
...
// ======== BEGIN OF SOLUTION - TASK 3_2-1 ======== //
    ...
    // smerove svetlo rovnou ulozeno v direction
...
// ======== BEGIN OF SOLUTION - TASK 3_2-2 ======== //
  ...
  sun.position = vec3(Vmatrix * vec4(cos(sunAngle), 0.0, sin(sunAngle), 0.0));
