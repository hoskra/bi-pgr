...
// ======== BEGIN OF SOLUTION - TASK 5_2-1 ======== //
  ...
  glm::vec4 tt = glm::vec4(t3, t2, t1);

  glm::mat3x4 P = glm::transpose(glm::mat4x3(P0, P2, P3));
...
// ======== BEGIN OF SOLUTION - TASK 5_2-2 ======== //
  ...
  glm::vec4 tt = glm::vec4(3.0f*t2, 2.0f*t, 1, 0);
...
// ======== BEGIN OF SOLUTION - TASK 5_3-1 ======== //
  float t0n = cyclic_clamp(t, 0.0f, float(count));  // t od nuly do poctu ridicich bodu
  int i = int(t0n);
